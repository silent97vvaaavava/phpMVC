...
class Admin extends Model {
	...
	public function postUploadImage($path, $id) {
		...
		$img->cropThumbnailImage(1080, 600); // миниатюра
		$img->setImageCompressionQuality(80); // качество
		$img->writeImage('public/materials/'.$id.'.jpg'); не работает у меня, скорее всего нет класса Imagick*/
